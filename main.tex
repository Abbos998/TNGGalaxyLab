...
truncated excerpt showing twenty representative disc galaxies
drawn from the 30-galaxy per-galaxy systematics subsample is
...
\begin{table}
  \centering
  \caption{Twenty-galaxy excerpt from the TNG50 demonstration catalogue,
    drawn from the 30-galaxy per-galaxy systematics subsample and sorted
    by fiducial $\Amone$ in descending order.  Column
    $\sigma^{\rm sys}(\Amone)$ is the standard deviation of $\Amone$
    across the five methodological alternatives listed in
    Table~\ref{tab:systematics}, providing a conservative per-galaxy
    uncertainty envelope that is larger than the pure bootstrap
    statistical error but includes methodological choices as well.
    The complete 915-galaxy catalogue is available in machine-readable
    form via the code repository (Zenodo DOI:~10.5281/zenodo.21363952).}
  \label{tab:catalog_excerpt}
  \begin{tabular}{rccc}
    \toprule
    Subhalo ID  &  $\Rd$ [kpc]  &  $\Amone^{\rm fid}$  &
    $\sigma^{\rm sys}(\Amone)$  \\
    \midrule
    592984  &  2.07  &  0.9426  &  0.0497  \\
    487742  &  3.18  &  0.7518  &  0.0925  \\
    556304  &  2.48  &  0.2257  &  0.0119  \\
    647687  &  2.80  &  0.1482  &  0.0143  \\
    571633  &  4.34  &  0.1473  &  0.0087  \\
    516101  &  2.26  &  0.1391  &  0.0030  \\
    602653  &  4.05  &  0.1388  &  0.0058  \\
    674074  &  4.84  &  0.1357  &  0.0124  \\
    641149  &  2.16  &  0.1355  &  0.0104  \\
    658180  &  3.49  &  0.1072  &  0.0158  \\
    607310  &  5.37  &  0.1049  &  0.0079  \\
    684910  &  1.98  &  0.1020  &  0.0071  \\
    625423  &  3.71  &  0.0913  &  0.0048  \\
    641885  &  1.73  &  0.0853  &  0.0102  \\
    683249  &  1.78  &  0.0725  &  0.0104  \\
    674132  &  2.11  &  0.0699  &  0.0060  \\
    514829  &  3.33  &  0.0686  &  0.0084  \\
    652446  &  3.54  &  0.0685  &  0.0118  \\
    645295  &  2.21  &  0.0560  &  0.0071  \\
    719882  &  1.30  &  0.0558  &  0.0075  \\
    \bottomrule
  \end{tabular}
\end{table}
